...
<%@ include file="nav/admin_nav.jsp" %>
    ...
    <section class="container py-5">
        ...
        <h1 class="col-12 col-xl-8 h2 text-left text-primary pt-3">회사소개 수정/삭제</h1>
        <h2 class="col-12 col-xl-8 h4 text-left regular-400"></h2>    
        <p class="col-12 col-xl-8 text-left text-muted pb-5 light-300"/>
         <form method="post"> 
        
         <textarea rows="15" cols="100" name="content">${intro.content}</textarea>
           <button type="submit">수정</button>
           <button type="button" onclick="location.href='/admin/introducedelete'">삭제</button>
